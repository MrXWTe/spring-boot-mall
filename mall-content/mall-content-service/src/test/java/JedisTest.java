...
//        nodes.add(new HostAndPort("192.168.1.157", 7001));
//        nodes.add(new HostAndPort("192.168.1.157", 7002));
//        nodes.add(new HostAndPort("192.168.1.157", 7003));
//        nodes.add(new HostAndPort("192.168.1.157", 7004));
//        nodes.add(new HostAndPort("192.168.1.157", 7005));
//        nodes.add(new HostAndPort("192.168.1.157", 7006));
